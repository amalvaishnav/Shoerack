...
<div id="main">
  ...
  <div id="content">
		<div id="vids"><center>
		   <h2>Profile</h2></center></div><div><font face="Georgia, Times New Roman, Times, serif"><center>
		   <h4 id='re'><align=left>
		   Admin Name- Amal Vaishnav<br>
		   username-amal<br>
		   password-****<br>
		   email id-amal.vaishnav96@gmail.com<br>
		   phn-9409171560<br></align>
		   </h4>
		<?php
		/*$c=@mysql_connect("localhost","root","");
		$k=@mysql_select_db("shoerack",$c);
